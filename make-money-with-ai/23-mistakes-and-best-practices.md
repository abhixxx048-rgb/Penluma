# Universal Mistakes & Best Practices

Every one of the 21 paths has its own pitfalls, but the same ten mistakes kill beginners across all of them. Learn these once and you're protected everywhere.
...
**3. Staying a generalist.** In every dataset — freelancing, agencies, editing, newsletters — the niche specialist wins. Generic cold outreach gets under 0.8% replies; one agency that niched into a single industry jumped to 6.2%. "For everyone" is read by buyers as "for no one."
...
**8. Chasing one-off gigs forever.** A one-time $500 project restarts you at zero. A $500/month retainer is $6,000/year and compounds. Every service chapter in this guide shows the same pattern: setup fee is the bait, the retainer is the business.
...
**7. Use AI for speed, humans for judgment.** The winning freelancers deliver in 2.5 hours what took 6, at the same rate. Let AI draft; you decide, edit, and take responsibility. That judgment layer is what you're actually selling.
...
The pattern behind all twenty items: the mistakes are all forms of impatience or vagueness; the best practices are all forms of specificity and follow-through. AI changed the tools. It didn't change that.
