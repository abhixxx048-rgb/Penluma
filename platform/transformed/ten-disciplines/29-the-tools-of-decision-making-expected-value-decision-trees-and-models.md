---
title: 'Expected Value, Decision Trees, and How to Decide Under Uncertainty'
metaTitle: 'Expected Value & Decision Trees Explained'
description: >-
  Learn how expected value, decision trees, and mental models help you make
  smarter choices under uncertainty-plus why a good decision can still lose.
...
faq:
  - q: What is expected value in simple terms?
    a: >-
      Expected value is the average payoff you'd get if you could repeat a choice
      many times. You multiply each possible outcome by its probability and add
      the results. It puts a single number on a risky choice.
  - q: What's the difference between risk and uncertainty?
    a: >-
      With risk you know the odds even if you can't predict the result, like a
      roulette wheel. With uncertainty you don't even know the odds, like
      launching a brand-new product. Most real decisions are uncertainty in a
      risk costume.
  - q: Why might I prefer a guaranteed $1 million over a 50/50 shot at $2 million?
    a: >-
      Both have the same expected value, but the first million changes your life
      far more than the second one adds. Money has diminishing marginal utility,
      so preferring the sure thing is rational risk aversion, not a mistake.
  - q: How do you use a decision tree?
    a: >-
      Draw squares for your choices, circles for chance events with their
      probabilities, and payoffs at the tips. Then fold back from the tips,
      computing expected value at each chance node and picking the best branch at
      each decision node.
  - q: What is resulting in decision-making?
    a: >-
      Resulting is judging a decision by its outcome instead of by the
      information you had when you made it. A smart bet that happens to lose was
      still smart; a reckless bet that happens to win was still reckless.
  - q: What is a one-way door versus a two-way door decision?
    a: >-
      A one-way door is hard or impossible to undo, so decide slowly and gather
...
| Second-order thinking | And then what? | Any move others will react to, or with delayed effects. |
