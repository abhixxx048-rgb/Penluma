---
title: 'Build a Second Brain So Your Best Ideas Stop Vanishing'
metaTitle: 'Build a Second Brain: Capture Your Best Ideas'
description: >-
  Learn how to build a second brain and an idea inventory so your best thoughts
  stop vanishing. Capture, organize, and connect ideas that compound over time.
keywords:
...
faq:
  ...
  - q: What is the CODE method for a second brain?
    a: >-
      CODE stands for Capture, Organize, Distill, Express. You save what
      catches your attention, put it where you can find it, boil it down to its
      point, and later pull notes together to make something useful.
  - q: What is the best app for building a second brain?
    a: >-
      The best tool is the one you will actually use. A plain text file or
      paper notebook beats a beautiful empty system. Start capturing first;
      refine the structure only when finding things gets hard.
  ...
  - q: How often should I review my notes?
    a: >-
      A 10-minute weekly skim plus a 20-minute monthly read of one topic is
      enough. Review is the engine: ideas only combine when you see them side
      by side again.
...
Here is how that looks in practice. Over one month you capture three unrelated notes:

1. A customer says, "I never know what stage my order is at."
2. A quote: "Uncertainty feels worse to people than bad news."
3. A passing observation that delivery apps text you at every step.

Alone, each is just a note. Reviewed side by side, they collide into a single clear idea: *send a plain status text at every order stage.* You did not invent that in a flash of genius. The **collection** did it. You just put the parts in one box.

## Capture daily, with as little friction as possible
...
The rhythm is simple: capture raw material each day, tidy and link it each week, hunt for patterns each month. Insights compound from there.
...
**"There's no point until I have a big system."**
Backwards. The first few weeks feel slow precisely because the value lives in the connections, and you do not have many notes yet. Ten notes give a few possible pairs; a hundred notes give thousands. The system feels pointless right up until it quietly becomes the thing you reach for constantly.

## How to use this today

1. **Start the inbox now.** Pick your one capture place. Write today's date, then capture three things from the last 24 hours: one thing you read, one thing someone said, one question that has been nagging you. Under each, add a single line: "Why this caught me."
2. **Tag five notes.** Add a simple tag or topic to your three new notes plus any two old, scattered notes you can find. Notice how findability already feels better.
3. **Force a collision.** Read any two unrelated notes side by side and write one sentence: "If these two were combined, what new idea appears?" Save that sentence as a new note.
4. **Book the review.** Put a recurring 10-minute "skim my notes" slot in your calendar this week. Treat it as the engine, not an extra chore.

Do this and your second brain is born. Tomorrow, add three more captures.
