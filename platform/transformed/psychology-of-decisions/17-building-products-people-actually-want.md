...
faq:
  ...
  - q: What is the Hook Model?
    a: It's a four-step loop from Nir Eyal - Trigger, Action, Variable Reward, Investment - that turns a repeated action into a habit. The variable (unpredictable) reward is the engine that keeps people coming back.
  - q: Is it easier to increase motivation or reduce friction?
    a: Reducing friction is almost always easier. Motivation fades fast, but if you make an action genuinely easy, people do it even on low-motivation days. This is the core lesson of BJ Fogg's B=MAP model.
  - q: What are dark patterns in product design?
    a: Dark patterns, or deceptive design, are interfaces built to trick users into acting against their own interest - like making cancellation painfully hard or hiding fees until checkout. Many are now illegal under laws like the EU's Digital Services Act.
  - q: How do I know if my design is ethical or manipulative?
    a: Use the transparency test. Ask whether the tactic would still work if the user knew exactly what you were doing. Honest persuasion survives disclosure; manipulation collapses the moment it's exposed.
...
|---|---|---|
| Yes | Yes | **Facilitator** - the goal. Build these. |
| Yes | No | **Peddler** - questionable; you don't believe in it. |
| No | Yes | **Entertainer** - fine if honest about it. |
| No | No | **Dealer** - exploitation. Don't. |
