/* Build the "Data Engineering & Systems Fundamentals" study guide HTML from the workflow output.
 * Usage: node build_pdf.cjs <workflow-result.json>
 * The JSON is either { result: {sections, wrapper} } or {sections, wrapper} (string or object). */
const fs = require('fs');
...
.cover .pillars{ font-size:11pt; color:#2a3a50; margin:0 auto 22mm; max-width:120mm; }
...
<section class="cover">
  <div class="kicker">Study Guide · Systems &amp; Data Foundations</div>
...
const htmlPath = path.join(OUT_DIR, 'Data-Engineering-Systems-Fundamentals.html');
