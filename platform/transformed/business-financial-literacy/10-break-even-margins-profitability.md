---
title: 'Break-Even Point: When Your Business Finally Makes Money'
metaTitle: 'Break-Even & Margins: When You Make Money'
description: >-
  Learn how to calculate your break-even point, contribution margin, and
  profit margins so you know exactly how much to sell before your business
  turns a profit.
...
keywords:
  ...
  - SaaS Rule of 40
faq:
  - q: What is a break-even point in simple terms?
    a: >-
      It's the exact sales level where the money coming in equals the money
      going out, so your profit is zero. Sell below it and you lose money;
      sell above it and you start keeping it.
  - q: How do I calculate my break-even point?
    a: >-
      Divide your fixed costs by your contribution margin per unit (selling
      price minus the variable cost of one sale). The result is how many units
      you must sell to cover everything.
  - q: What is contribution margin?
    a: >-
      It's the money left from a single sale after you pay that sale's variable
      costs. Each sale "contributes" this amount toward paying your fixed costs,
      and after those are covered, toward profit.
  - q: What is the difference between gross margin and net margin?
    a: >-
      Gross margin is what's left after the cost of making the product. Net
      margin is what's left after absolutely everything, including operating
      costs, interest, and tax, the true bottom line.
  - q: Is a 10% net margin good?
    a: >-
...
**Myth: "My founder salary and rent are basically free for now."**
Reality: if a cost will eventually be paid every month, it's a fixed cost, full stop. Pretending it's free makes your break-even look far rosier than it is, and you'll run out of cash by surprise.

**Myth: "If I'm losing money per sale, I'll make it up in volume."**
Reality: if your variable costs equal or beat your price, *every extra sale loses you money*. No amount of scaling fixes negative contribution margin, it just digs the hole faster. Fix the price or the costs first.

**Myth: "A big sale means we made money."**
Reality: revenue is not profit. A sale only helps once its contribution margin has gone toward covering fixed costs. Watch margins, not just top-line sales.

**Myth: "My net margin looks bad compared to those software companies."**
Reality: a founder panicking that their ecommerce store is "only" 38% gross margin while software sits at 80% is comparing apples to rockets. Always benchmark against *your* model.
...
1. **List every cost** you have, then sort each one into fixed or variable using the "do I pay it even with zero sales?" test.
2. **Calculate your contribution margin per unit:** selling price minus variable cost. If it's zero or negative, stop and fix your pricing before anything else.
3. **Find your break-even point** in both units and dollars: fixed costs ÷ contribution margin, and fixed costs ÷ contribution margin ratio.
4. **Set a profit target** and find the sales needed: (fixed costs + target profit) ÷ contribution margin per unit.
5. **Pin the numbers where you'll see them daily.** "667 sales / $16.7k to survive" beats any vague growth slogan.
6. **Check your three margins** against the benchmark for *your* industry, not someone else's.
7. **Watch your fixed-cost level.** The higher it climbs, the more leverage you have, more reward above break-even, more danger below it.
