---
title: The Product Sense Glossary Every Designer Should Know
metaTitle: Product Sense & UX Glossary Explained
description: A plain-language glossary of product sense and UX terms — affordances, mental models, Hick's Law, cognitive load, and more — explained with real examples.
keywords:
  - product sense glossary
  - UX terms explained
...
faq:
  - q: What is product sense?
    a: Product sense is the skill of judging what to build and why it matters to a real person — before and during the build. It's about choosing the right thing to make, not just making things well.
  - q: What is the difference between an affordance and a signifier?
    a: An affordance is what an object lets you do (a button affords pressing). A signifier is the visible cue that tells you the affordance exists (the button looks raised and clickable). Affordances are possibilities; signifiers are the hints.
  - q: What is cognitive load in UX design?
    a: Cognitive load is the total mental effort a screen demands. The more a user must hold in their head at once, the harder and more tiring the product feels. Good design lowers it.
  - q: What does Hick's Law say about choices?
