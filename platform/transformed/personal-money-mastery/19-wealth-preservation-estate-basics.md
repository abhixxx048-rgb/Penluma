---
title: "Nominee vs Legal Heir: Why Your Money May Not Go to Whom You Think"
metaTitle: "Nominee vs Legal Heir in India: The Basics"
description: "Nominee is not owner. Learn how wills, nomination, and succession law in India decide who really inherits your money, and how to protect your family."
keywords:
  - nominee vs legal heir
  - estate planning India
  - how to write a will in India
  - Hindu Succession Act Class I heirs
  - inheritance tax India
  - succession certificate cost
  - SEBI 10 nominee rule
  - capital gains on inherited shares
  - probate India
  - life insurance nominee owner
  - intestate succession
  - registered will benefits
  - asset register
  - wealth preservation
faq:
  - q: "Is a nominee the legal owner of my bank account or mutual fund?"
    a: "No. For banks, mutual funds, demat accounts, and shares, a nominee only collects the asset and holds it in trust for your legal heirs. Ownership is decided by your will or by succession law, not by nomination."
  - q: "Does a will override a nomination in India?"
    a: "Yes. A valid will decides who actually owns an asset and overrides a nomination every time. The nominee may receive the money, but they must pass it to whoever the will names as owner."
  - q: "Is there inheritance or estate tax in India?"
    a: "No. India abolished estate duty in 1985 and gift tax in 1998. Inheriting an asset is tax-free. Tax only applies later when the inherited asset earns income or is sold."
  - q: "What happens if I die without a will in India?"
    a: "You die intestate and the law decides. For Hindus, the property is split equally among Class I heirs, which include the widow, mother, sons, and daughters. Daughters have had equal coparcenary rights by birth since 2005."
  - q: "Is a will valid without registration or stamp duty?"
    a: "Yes. A will needs no stamp duty and can be handwritten on plain paper, signed by you and attested by two witnesses who are not beneficiaries. Registration is optional but strongly recommended because it makes the will much harder to challenge."
...
1. **Joint account?** If yes, the survivor takes custody (but may still hold the deceased's share for that person's heirs).
2. **Nominee registered?** If yes, the nominee collects the asset.
3. **Will exists?** If yes, the will decides ownership. The nominee is only a trustee, except for the life insurance family exception above.
4. **No will?** Succession law (the Hindu Succession Act and others) decides ownership.
...
1. **Write a will this month.** Plain paper, your signature, two non-beneficiary witnesses. State clearly who owns what.
2. **Register it** with the Sub-Registrar for a few hundred rupees. It dramatically strengthens the will against challenges.
