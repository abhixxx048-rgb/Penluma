---
title: 'Where to Keep Cash: Savings, FDs & Safe Places That Beat 3%'
metaTitle: 'Where to Keep Cash Safely (India Guide)'
description: >-
  Where should your cash actually sit? A plain-English guide to savings accounts,
  FDs, liquid funds, T-bills, DICGC insurance, and post-tax returns for India.
...
keywords:
  ...
  - best place to park emergency fund
  - savings account vs fixed deposit
  - liquid mutual funds India
  - DICGC deposit insurance 5 lakh
  - treasury bills RBI Retail Direct
  - sweep in FD
  - post tax FD returns
  - safe saving instruments India
  - high yield savings account
faq:
  - q: Where is the safest place to keep my cash in India?
    a: >-
      For everyday money, a bank savings account is safest and instant. For
      money you won't touch for months, fixed deposits and liquid funds are
      very safe. The single safest rupee instrument is a Treasury Bill, because
      the Government of India backs it directly.
  - q: How much bank deposit is insured in India?
    a: >-
      DICGC insures up to ₹5 lakh per depositor, per bank - and that covers your
      principal plus interest combined across all accounts in that one bank. If
      you hold more, split it across different banks so each balance stays under
      the cap.
  - q: Is a fixed deposit or a liquid fund better?
    a: >-
      An FD has a slightly higher headline rate and a break penalty if you exit
      early. A liquid fund pays a little less but you can redeem in about a day
      with no penalty. After tax they are closer than they look, so compare
      post-tax returns and weigh the flexibility.
  - q: Why is keeping all my savings in a savings account a mistake?
    a: >-
      If the account pays around 3% and inflation runs 5–6%, you lose purchasing
      power every year - a guaranteed real loss even though the rupee number
      rises. Keep about one month of expenses there and move the rest to
      higher-yielding safe options.
  - q: Are liquid funds and T-bills covered by deposit insurance?
    a: >-
      No. DICGC only covers money held in banks. Liquid funds get their safety
      from holding very short-term, high-quality debt, and T-bills are backed
      directly by the government - which is actually the strongest backing of all.
  - q: How much tax do I pay on FD and savings interest?
    a: >-
...
1. **Tier 1 - Daily cash (about 1 month of expenses).** Keep it in a savings account for instant access.
2. **Tier 2 - Emergency fund (3–6 months; if your income is lumpy, 6–12 months).** Split it for the best mix of safety and speed.
3. **Tier 3 - A known short-term goal (under a year).** Use an FD or T-bill that matures near the goal's date.
...
1. Total up how much "safe cash" you're holding, and *where* it sits.
