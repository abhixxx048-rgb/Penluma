---
title: 'How Economists Think: Incentives, Margins, and Models'
metaTitle: 'How Economists Think: Incentives & Margins'
description: >-
  Learn how economists think using incentives, thinking at the margin, and
  simple models. A clear guide to the mental moves that explain everyday choices.
keywords:
  ...
  - opportunity cost
faq:
  - q: What does "thinking at the margin" mean?
    a: >-
      It means judging the next single unit, not the whole. Instead of asking
      "is pizza good?" you ask "is the fourth slice worth it right now?" You act
      while the extra benefit beats the extra cost, and stop when they're equal.
  - q: Why are diamonds expensive but water is cheap?
    a: >-
      Price tracks the value of one more unit, not total value. Water is
      abundant, so your next glass is worth almost nothing. Diamonds are scarce,
      so the next one is precious. Scarcity at the margin sets the price.
  - q: What is the cobra effect?
    a: >-
      It's when a fix makes a problem worse because people game the reward.
      A bounty on dead cobras led people to breed cobras for cash. When the
      bounty ended, the snakes were released and the population rose.
  - q: What is the sunk cost fallacy?
    a: >-
      It's throwing good money after bad because you've "already invested so
      much." Money already spent and unrecoverable should not drive future
      choices. Only the costs and benefits still ahead of you matter.
  - q: What is comparative advantage?
    a: >-
      It's the idea that you should specialize in whatever you give up the least
      to make, then trade for the rest. This works even when someone else is
      better than you at everything, because both sides still gain.
  - q: Are people really rational, like economics assumes?
    a: >-
      Not perfectly. People have limited information and attention, feel losses
      more than gains, and value fairness. The rational model is a useful
      starting point, but humans are predictably imperfect.
...
| **Rationing device** | Steers the scarce good toward those who value it most. |
