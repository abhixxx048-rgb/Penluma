---
title: 'Why the Rich Get Richer: Inequality Explained Simply'
metaTitle: 'Wealth Inequality and Poverty Explained'
description: 'Understand wealth inequality, why the rich get richer, and how poverty really works. A clear, jargon-free guide to income, wealth, and mobility.'
keywords:
  - wealth inequality
  - income vs wealth
...
faq:
  - q: What is the difference between income and wealth?
    a: Income is a flow of money you earn over time, like a yearly salary. Wealth is a stock of value you hold at a single moment, everything you own minus everything you owe. Wealth is always far more concentrated than income because assets compound.
  - q: Why do the rich keep getting richer?
    a: Because wealth compounds. Once you own assets, they earn income like rent, dividends, and interest, which you can reinvest into more assets. Wages do not compound that way, so owners of capital tend to pull ahead over time.
  - q: What is the Gini coefficient?
    a: It is a single number between 0 and 1 that measures how unequal a distribution is. 0 means everyone has exactly the same; 1 means one person has everything. It is useful for comparison but hides what happens at the extreme top and bottom.
  - q: Is global poverty getting worse?
    a: No. Extreme absolute poverty fell from roughly 36% of humanity in 1990 to around 9 to 10% by the late 2010s, mostly thanks to growth in China and India. What is rising is relative inequality within wealthy countries.
  - q: Does reducing inequality hurt economic growth?
    a: Moderate redistribution generally does not harm growth, and IMF research finds more-equal societies often sustain longer growth spells. Only extreme redistribution tends to backfire. The old "leaky bucket" fear is real but smaller than once believed.
  - q: What is the Great Gatsby Curve?
    a: It is a pattern showing that more unequal countries tend to have less social mobility. In other words, where the gap is wide, it is usually harder for children to climb above their parents' income rank.
...
| **Threshold** | Fixed subsistence line | Tied to local median income |
| **Typical line** | World Bank: $2.15/day (2017 prices), raised June 2025 to $3.00/day | Below 60% of median disposable income (OECD/EU) |
| **Can growth end it?** | Yes, and largely has in much of the world | No, it shifts with the median and never vanishes |
