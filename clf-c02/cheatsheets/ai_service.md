...
Rekognition	Image & video analysis (detect faces, objects, text in images)
Transcribe	Speech → Text (audio to written words)
Polly	Text → Speech (written words to audio)
...
Personalize	Real-time personalized recommendations (like Netflix/Amazon suggestions)