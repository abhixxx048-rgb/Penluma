---
title: "Stock Valuation Basics: Are You Overpaying for a Stock?"
metaTitle: "Stock Valuation Basics for Beginners"
description: "Learn stock valuation basics: how to tell price from value, read P/E and EV/EBITDA, dodge value traps, and use a margin of safety before you buy."
keywords:
  - stock valuation basics
  - price vs value investing
  - what is P/E ratio
  - EV/EBITDA explained
  ...
  - how to value a stock for beginners
  - Nifty 50 P/E
  - LTCG tax on shares India
  - DCF for beginners
...
faq:
  ...
  - q: "What does the P/E ratio actually tell you?"
    a: "P/E is the share price divided by earnings per share. It tells you roughly how many years of today's profit you are paying for the company. A P/E of 20 means you pay 20 rupees for every 1 rupee of annual profit."
  - q: "Is a low P/E stock always a good buy?"
    a: "No. A low P/E can signal a bargain, but it often means the business is shrinking, cyclical at a peak, or in trouble. This is called a value trap. You need both a cheap price and a durable business before it counts as a real bargain."
  - q: "What is a margin of safety in investing?"
    a: "It means only buying when the price sits meaningfully below your estimate of the stock's worth, such as paying 70 for something you reckon is worth 100. That buffer protects you when your estimate turns out to be wrong."
  - q: "How is long-term capital gains tax on shares calculated in India?"
    a: "For listed equity held over one year, LTCG is taxed at 12.5% on gains above 1.25 lakh rupees per year (rules effective 23 July 2024). Shares held one year or less are taxed at 20% short-term."
  - q: "Why is EV/EBITDA better than P/E for some companies?"
    a: "EV/EBITDA accounts for a company's debt, so it compares two firms fairly even when they carry very different debt loads. It is the preferred yardstick for capital-heavy, leveraged, or cash-rich-but-low-profit businesses."
sources: []
---
...
1. **Past vs future.** *Trailing* P/E uses last year's real profit; *forward* P/E uses optimistic estimates that may never come true.
2. **One-off gains.** Selling a building inflates this year's "E," making the P/E look falsely cheap.
3. **Cyclical traps.** Steel and auto firms show their *lowest* P/E at peak earnings, right before a downturn.
4. **Negative earnings.** If profit is negative, P/E is meaningless.
5. **Cross-sector nonsense.** Comparing the P/E of an FMCG brand to a public-sector bank is invalid. They deserve completely different multiples.
...
1. **Separate price from value first.** Ask "what is this business actually worth to me?" before you look at the quote.
2. **Pick the right yardstick for the business.** P/E and PEG for steady profit-makers, P/B for banks and asset-heavy firms, EV/EBITDA for leveraged or cash-rich-low-profit companies, ARR multiples for startups.
3. **Never compare multiples across sectors.** A bank's "cheap" and an FMCG brand's "cheap" mean different things.
4. **Treat a low ratio as a question, not an answer.** Ask *why* it's cheap. If the business is shrinking, it's a value trap.
5. **Demand a margin of safety.** Buy below your estimate of worth. The more uncertain you are, the bigger the discount.
6. **Sanity-check with rough DCF logic.** You don't need a spreadsheet, just the three steps. If the numbers only work with heroic growth assumptions, walk away.
7. **Mind the holding period.** Crossing the one-year mark can roughly third your tax bill on the same gain.
8. **Pull the real data yourself.** Free tools like Screener.in and Trendlyne show P/E, P/B, EV/EBITDA, debt, and promoter-pledge levels before you trust anyone's "tip."
