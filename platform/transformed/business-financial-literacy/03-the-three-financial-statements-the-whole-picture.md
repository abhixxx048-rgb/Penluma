---
title: "The 3 Financial Statements Explained (Without the Jargon)"
metaTitle: "The 3 Financial Statements, Explained Simply"
description: "Every business tells its money story with just three reports. Learn what each financial statement answers and how they connect into one clear picture."
keywords:
...
faq:
  - q: What are the three financial statements?
    a: The income statement (did we make a profit?), the balance sheet (what do we own and owe?), and the cash flow statement (where did the cash actually go?). Together they describe a business from three angles.
  - q: What is the difference between the income statement and the balance sheet?
    a: The income statement covers a period of time and shows profit or loss. The balance sheet is a snapshot of a single moment, showing what the business owns and owes right then.
  - q: Why can a profitable company still run out of cash?
    a: Profit can be earned before cash arrives. Money may be tied up in unpaid invoices or inventory, so the income statement shows a profit while the bank account is empty. The cash flow statement reveals this.
  - q: What is the difference between accrual and cash accounting?
    a: Cash accounting records revenue when money lands in your account. Accrual accounting records revenue when you earn it, even if the customer hasn't paid yet. Accrual gives a more honest profit picture.
  - q: What is the accounting equation?
    a: Assets = Liabilities + Equity. It always balances, which is why one of the three statements is called the "balance" sheet.
  - q: How do the three financial statements connect?
    a: Net income from the income statement flows into equity (as retained earnings) on the balance sheet, and into the cash flow statement, which produces the ending cash that appears back on the balance sheet.
---
...
| Statement | Also called | The one question it answers |
|---|---|---|
...
|---|---|---|
| Record revenue when… | cash lands in your account | you earn it (deliver the goods or service) |
