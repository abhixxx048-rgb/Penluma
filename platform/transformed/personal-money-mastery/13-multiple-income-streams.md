...
faq:
  - q: "How many income streams should I have?"
    a: "There is no magic number like seven. Start with one excellent active income stream, then add portfolio and passive streams as you build capital and free up attention. Order matters far more than count."
  - q: "What is the difference between active, portfolio, and passive income?"
    a: "Active income trades your time for money (salary, freelance). Portfolio income is earnings on money you already own (capital gains, interest, dividends). Passive income is cash flow from an asset or system that runs largely without your daily labour (rent, royalties)."
  - q: "Is passive income really passive?"
    a: "Rarely. Almost every passive stream has a heavy active build phase and ongoing maintenance. Rental income, for example, is semi-active because vacancies, repairs, and tenant management never fully stop."
...
| --- | --- | --- |
| Listed equity / equity MF | **20%** (up from 15%) | **12.5%** above 1.25L per year; held over 12 months |
| Property, gold, other assets | Slab rate | **12.5% flat, no indexation** (property bought before 23 Jul 2024 may opt for 20% with indexation) |
| Debt MF (bought after Apr 2023) | Always slab rate | No long-term benefit |
