---
title: "Why Are Some Countries Rich? The Math Behind Growth"
metaTitle: "Economic Growth and Productivity Explained"
description: "Economic growth and productivity decide why some countries are rich and others poor. Learn the Rule of 70, the Solow model, and why institutions matter most."
keywords:
  - economic growth
  - productivity
  - real GDP per capita
  ...
  - GDP explained
faq:
  - q: What is the difference between economic growth and the business cycle?
    a: Growth is the slow, long-run rise in living standards over decades. The business cycle is the short-run wiggle of booms and recessions around that trend. A recession is a temporary dip; slow growth is a weak long-term trend, and they need different fixes.
  - q: What is the Rule of 70?
    a: It is a shortcut for how long something takes to double. Divide 70 by the yearly growth rate. At 2% a year, living standards double in about 35 years; at 7%, in about 10 years.
  - q: Why is productivity so important for living standards?
    a: Because on average you can only consume what you produce. Higher output per hour lets firms pay higher wages and households buy more, which is why productivity is the best predictor of long-run wealth.
  - q: Can a country grow rich just by building more factories?
    a: No. Because of diminishing returns to capital, adding machines without new ideas eventually hits a steady state where growth stalls. Only technological progress sustains growth indefinitely.
  - q: Why are some countries rich and others poor?
    a: The most influential modern answer is institutions. Inclusive rules with secure property rights and checks on power encourage investment and innovation, while extractive rules that let an elite seize wealth strangle it.
  - q: Is real GDP or real GDP per capita the better measure of living standards?
    a: Real GDP per capita. Total GDP can grow while the average person gets poorer if population grows even faster, so per-capita output is the number that tracks welfare.
...
| Type | The claim | Does the evidence support it? |
|---|---|---|
