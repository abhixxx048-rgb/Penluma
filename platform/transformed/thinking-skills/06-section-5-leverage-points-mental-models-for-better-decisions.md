---
title: 'Leverage Points and Mental Models: Make Smarter Decisions'
metaTitle: 'Leverage Points & Mental Models Guide'
description: >-
  Learn how leverage points and mental models help you make better decisions by
  finding where a small push creates lasting change instead of just trying harder.
...
keywords:
  ...
  - Hanlon's razor
faq:
  - q: What are leverage points in a system?
    a: >-
      Leverage points are places where a small, well-aimed change creates a large
      and lasting shift. Donella Meadows ranked twelve of them, from weak ones like
      tweaking numbers to powerful ones like changing a system's goals or paradigm.
  - q: What is a mental model?
    a: >-
      A mental model is a thinking tool that helps you see reality more clearly,
      like a lens. No single lens shows everything, so the best decision-makers use
      several at once to get a fuller picture of a problem.
  - q: What is second-order thinking?
    a: >-
      Second-order thinking asks "and then what?" beyond the first obvious result.
      It traces the chain of later consequences that most people miss, which is
      often where the real risks and opportunities hide.
  - q: What is inversion in decision making?
    a: >-
      Inversion means asking "what would guarantee failure?" instead of "how do I
      succeed?" You list the reliable ways to fail and avoid them. Avoiding obvious
      mistakes is often easier and more reliable than chasing brilliance.
  - q: Why do people ignore base rates?
    a: >-
      People focus on the vivid story in front of them instead of what usually
      happens to similar situations. Kahneman called this base rate neglect. The fix
      is to start with the historical average, then adjust for your specifics.
  - q: How many mental models do I actually need?
    a: >-
...
1. **Information flows.** Who sees what data, and when? Meadows wrote that missing feedback is one of the most common causes of system breakdown. Giving your team a real-time dashboard for customer churn, when before they only saw it once a quarter, is a real intervention — not a cosmetic one.
2. **Rules.** Incentives and constraints drive behavior far more than pep talks. Change a sales commission from "units sold" to "customers still here after 90 days," and you reshape thousands of interactions automatically.
3. **Goals.** What the system optimizes for is a deep lever. A hospital that measures "beds filled" behaves nothing like one that measures "patients discharged healthy." Same staff, same building, completely different system.
4. **Paradigms.** The shared mental model of the people inside. The hardest to shift, and the most powerful. When Amazon stopped thinking "we sell books" and started thinking "we are a logistics and infrastructure company," hiring, products, and capital allocation all changed with it.
