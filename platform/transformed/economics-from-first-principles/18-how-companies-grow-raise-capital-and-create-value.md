...
description: >-
  ...
  to VC, dilution, and the chain that turns one investment into higher wages.
keywords:
  ...
  - venture capital rounds explained
  - profit vs cash flow
  - retained earnings compounding
  - how investment raises wages
  - startup valuation basics
  - bootstrapping a business
  - why startups fail cash flow
faq:
  - q: What is the difference between value creation and value capture?
    a: >-
      Value creation is the total usefulness a product brings into the world.
      Value capture is the slice the company keeps as profit, mostly through
      pricing. A healthy business does both - and its slice is usually far
      smaller than the total value it creates.
  - q: Should a startup raise debt or equity?
    a: >-
      Debt suits firms with steady cash flow and assets to pledge, because you
      must repay it win or lose. Equity suits risky, fast-growing firms with no
      collateral, because there is nothing to repay - but you give up ownership.
  - q: What does dilution mean for a founder?
    a: >-
      Dilution means your ownership percentage falls when the company issues new
      shares, even though your share count stays the same. A smaller slice of a
      much bigger company can be worth far more than 100% of a tiny one.
  - q: Can a profitable company still go bankrupt?
    a: >-
      Yes. Profit measures long-run viability, but cash flow measures short-run
      survival. Timing gaps and growing too fast can leave a profitable business
      unable to pay this week's bills.
  - q: How does business investment lead to higher wages?
    a: >-
      Investment buys better tools, which gives each worker more to work with.
      More tools per worker raises productivity, and over time wages track
      productivity as employers compete for more valuable workers.
...
1. **The customer.** They might have happily paid £5, but paid only £3 - pocketing £2 of "consumer surplus," the gap between what they would have paid and what they did.
2. **The bakery.** Its profit, after costs.
3. **The suppliers.** The people who sold the flour, the sugar, and the labour.
...
1. **Separate creation from capture in any business you study.** Ask: what value does it create, and how does it keep a slice? A company strong on one but weak on the other is fragile.
2. **Match your funding tool to your cash flow.** Steady, predictable revenue with assets? Debt is cheaper than giving up ownership. Risky and fast-growing with no collateral? Equity is your route.
3. **Model your dilution before you raise.** Use new money ÷ post-money to see the investor's slice. Decide whether the bigger pie is worth the smaller percentage.
4. **Triangulate any valuation.** Never trust a single number. Sanity-check a DCF against market multiples like P/E or P/S, and treat the result as a negotiating range.
5. **Watch cash, not just profit.** Track the bank balance and your timing gaps as closely as the income statement. Growing too fast can kill a profitable firm.
6. **Reinvest only where returns beat your cost of capital.** Compounding is magic only when each retained dollar earns a high return. When the high-return ideas run out, return the cash.
