---
title: 'How Your Mind Really Works: Perception, Attention, Memory, and Fast vs. Slow Thinking'
metaTitle: 'How the Mind Works: Perception to Thinking'
description: >-
  Your mind doesn't record reality, it builds it. Learn how perception, attention,
  memory, and fast vs. slow thinking shape every decision you make.
keywords:
  - how the mind works
  ...
  - why we forget
faq:
  - q: Does the brain record reality like a camera?
    a: No. Your brain constructs your experience from incomplete sensory data and your own expectations. That is why optical illusions fool everyone and why two honest people can perceive the same event differently.
  ...
  - q: What is the best way to study so I actually remember?
    a: Use the spacing effect (spread sessions over days instead of cramming) and the testing effect (quiz yourself instead of rereading). The effort of recalling strengthens memory, while rereading only feels like learning.
  - q: Can a memory feel certain but still be wrong?
    a: Yes. Memory is reconstructive, so it can quietly change each time you recall it. Research on eyewitnesses shows a single leading question can plant a false detail, and confidence is not proof of accuracy.
...
| Example task | 2 + 2; reading a word; sensing anger in a face | 17 x 24; a tax form; weighing a job offer |
