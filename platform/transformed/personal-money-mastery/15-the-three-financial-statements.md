...
keywords:
  ...
  - accrual accounting
  - startup cash runway
  - financial statements for founders
  - retained earnings
  - corporate tax India
faq:
  - q: "What are the three financial statements?"
    a: "The profit and loss statement (P&L) shows performance over a period, the balance sheet shows your position on a single date, and the cash-flow statement shows the actual cash that moved in and out. Each answers a different question, and you need all three."
  - q: "Why can a profitable company run out of cash?"
    a: "Profit is recorded when a sale is earned, not when cash arrives. Money can be tied up in unpaid customer invoices, unsold stock, or equipment, so you can post a healthy profit while your bank balance falls."
  - q: "What is the difference between profit and cash flow?"
    a: "Profit is an accounting opinion formed under accrual rules; cash is a fact you can check in your bank account. Receivables, inventory, equipment purchases, depreciation, and loan repayments all break the link between the two."
  - q: "What is the cash conversion cycle?"
    a: "It measures how many days your cash is trapped in operations: days customers take to pay you, plus days stock sits unsold, minus days you take to pay suppliers. Lower or even negative is better."
  - q: "Is GST collected from customers counted as revenue?"
...
**The Profit and Loss statement (P&L)**, also called the income statement, measures your **performance over a period**, a month, a quarter, or a year. It answers: "How much did we earn and spend between April and March?" It is a movie of the period.

**The Balance Sheet** is a **snapshot on one single date**. It answers: "What do we own and owe as of 31 March?" It is a photograph, not a movie.

**The Cash-Flow Statement** tracks the **actual cash** that moved in and out over a period. It answers: "How did our bank balance change, and why?"
...
The P&L reads top to bottom. You start with sales, then peel off one layer of cost at a time until you reach the famous "bottom line."
...
| --- | --- | --- |
| Cash, money customers owe you (receivables), inventory, prepaid expenses | Money you owe suppliers (payables), short-term debt, GST and tax payable | Share capital |
| Machinery and equipment, intangibles | Long-term loans | Retained earnings |
...
Profit is formed under accrual rules, which make judgement calls about when a sale "counts." Cash is just what is in the bank. These are the five places where they pull apart:
...
```
  Operating cash flow
    ...
    − 30 (receivables) − 10 (inventory) + 8 (payables)   =  − 15.75 L
...
```
  CCC  =  DSO  +  DIO  −  DPO
          │      │      └ Days you take to pay suppliers (longer is better)
          │      └ Days stock sits before selling (shorter is better)
          └ Days customers take to pay you (shorter is better)
```
...
**"We are profitable, so we are fine."** The most expensive sentence in business. Profit and cash are different numbers. Always read all three statements together, because a balance sheet that "balances" can still be hiding a cash crisis.

**"The GST I collect is revenue."** No. The GST a customer pays you is not yours, it is a liability you owe the government. It never belongs in your revenue line. Treating it as income is a fast way to overstate how well you are doing.

**"Depreciation costs me cash each year."** It does not. The cash left the day you bought the asset. Depreciation is just an accounting way of spreading that past cost across future years. No rupee moves when you record it.

**"A bigger profit always means a healthier company."** Not if that profit is locked in unpaid invoices and unsold stock. A smaller profit that converts quickly to cash is often a far stronger position.
...
So next time someone tells you a business is "very profitable," you will know to ask the better question: yes, but is it collecting? Because the moment you start tracking how fast money moves rather than just how much you earned, you stumble onto the next frontier of finance, the world of working capital and the cash conversion cycle, where the smartest companies have learned to make their growth pay for itself.
