---
title: "Compounding: Why Starting Early Beats Investing More"
metaTitle: "Compounding & Time Value of Money Explained"
description: "Compounding rewards time more than money. Learn how the time value of money works, why starting early wins, and how to protect your returns from inflation."
...
faq:
  - q: What is the time value of money in simple terms?
    a: It means money you have today is worth more than the same amount in the future, because today's money can earn a return and because inflation erodes what future money will buy. You can't fairly compare two amounts at different dates until you move them to the same date.
  - q: What is the Rule of 72?
    a: It's a shortcut to estimate how long money takes to double. Divide 72 by your annual return percentage. At 12% a year, money doubles in roughly six years (72 ÷ 12).
  - q: Is it better to start investing early or invest more money later?
    a: Starting early usually wins. Because early contributions get the most years to compound, a smaller amount invested sooner often beats a larger amount started a decade later.
  - q: Why might a fixed deposit lose me money?
    a: FD interest is fully taxable. A 6.5% FD taxed at 30% nets about 4.55%, which is below typical long-run inflation of around 6%, so your purchasing power can quietly shrink even though the balance grows.
  - q: How does a small expense ratio affect my returns?
...
This is the single costliest delay there is. A small SIP started today beats a large one started in five years. Begin with 1,000 a month if that's all you can spare. The habit and the time matter far more than the amount.

**"A fixed deposit or savings account is safe."**
It's *nominally* safe, but FD interest is fully taxable. A 6.5% FD taxed at 30% nets about 4.55%, which is below 6% inflation. So you're **losing purchasing power** while feeling secure. Even a "safe" 7.1% PPF barely clears 1% real. Risk isn't only price swings. The bigger silent risk is failing to beat inflation.

**"A fund's 1% fee is too small to worry about."**
Over decades, that 1% compounds against you. A 1% higher expense ratio over 30 years can shrink your final corpus by roughly **25%.**

**"100% total return means I doubled my money fast."**
Always *annualise* before judging. A fund that gave 100% total return over 10 years only compounded at about 7.2% a year, which a plain index fund likely beat.
