---
title: 'Emotional Design: How to Build Products People Love'
metaTitle: 'Emotional Design: Build Products People Love'
description: >-
  Emotional design is why people remember and recommend products. Learn Norman's
  three levels, the peak-end rule, and how to design real delight that lasts.
...
faq:
  - q: What is emotional design?
    a: >-
      Emotional design is the practice of shaping how a product makes people feel,
      not just whether they can use it. It targets gut reactions, the feeling of
      competence while using it, and the story users tell afterward.
  - q: What are Don Norman's three levels of emotional design?
    a: >-
      Visceral (the instant gut reaction to how something looks and feels),
      behavioral (whether it feels easy and makes you feel capable), and
      reflective (the meaning, pride, and story you attach to it). All three
      fire at the same time.
  - q: What is the aesthetic-usability effect?
    a: >-
      It is the tendency for people to perceive attractive products as easier to
      use, whether or not they actually are. Beauty buys forgiveness for small
      flaws, but it cannot hide a broken core experience.
  - q: What is the peak-end rule in UX?
    a: >-
      People judge an experience mostly by its most intense moment (the peak) and
      its ending, not by the average of every moment. Design a strong high point
      and a clean, reassuring finish.
  - q: What is the difference between surface delight and deep delight?
    a: >-
...
## The three channels firing in every user's head

Don Norman, the designer who co-founded the Nielsen Norman Group and wrote *The Design of Everyday Things*, laid out three ways our brains react to a product in his book *Emotional Design*.

These are not steps or a ladder. They all fire at once, like three radio stations playing at the same time.
...
The slow, thinking layer: meaning, memory, identity, pride. *"What does using this say about me? Would I recommend it? Am I proud of it?"*

This is where word of mouth and loyalty live, and it can override the other two. People put up with an uncomfortable luxury product because of what it signals about them.

**A quick example.** A shop owner sets up her online store. *Visceral:* the dashboard looks clean and modern, so she relaxes. *Behavioral:* adding her first product is smooth, so she feels capable. *Reflective:* she texts the store link to a customer and thinks, *"I built this, and it looks legit."* That last thought is the one that brings you the next shop owner.
...
**"Beauty can hide a broken product."** No. A pretty design buys forgiveness for *minor* problems, not large ones. A gorgeous checkout that loses an order still loses you the customer. Beauty is a discount on small flaws, never a license for big ones.

**"Delight means animations and easter eggs."** Those are nice, but they are the surface. Real delight is built on a product that simply works. A fun animation on a checkout that fails is just friction wearing a costume.

**"Emotion is fluffy and you can't measure it."** Emotion drives the most measurable thing there is: whether people come back and whether they tell others. It is the engine behind retention and word of mouth.

## Surface delight vs deep delight

**Delight** is a moment of pleasure beyond what the user expected. It comes in two very different sizes, and confusing them is where most teams go wrong.

**Surface delight** is the local stuff: a playful animation, a clever line of copy, a mascot, a hidden easter egg. It gives an occasional "wow." On its own, it cannot make a bad experience good.

**Deep delight** is whole-product satisfaction. The product is functional, reliable, usable, convenient, *and* pleasurable. It feels like a knowledgeable assistant that anticipates what you need. You earn it only when the basics are rock solid.
...
### Celebrate the user's win

The best place to put a designed peak is the user's moment of triumph. Two well-known examples:
...
1. **Pick the one feeling you want to engineer.** For most products it is confidence. Write it down and judge every screen against it.
2. **Fix the base before the polish.** Make it functional, reliable, and usable first. Only then add the pleasurable touches.
3. **Audit your visceral first impression.** Open your product cold, the way a stranger would. Does the first half-second feel trustworthy or cheap? Fix that before anything else.
4. **Turn every confirmation into human feedback.** Hunt down robotic messages and rewrite them as warm, plain-language wins.
5. **Map your peak and your end.** Identify the user's biggest moment of triumph and celebrate it. Make the final screen of any flow calm and reassuring, never abrupt.
6. **Keep delight out of the way.** If an animation or easter egg slows the task or blocks a next step, cut it.
7. **Ask what job you were hired for.** Before adding a feature, ask what progress and what feeling the user is really after.
