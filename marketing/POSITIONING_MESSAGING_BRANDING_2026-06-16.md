...
|---|---|---|---|
| **Positioning** | The strategic context you choose so customers instantly "get" what you are and why you're the obvious choice. | Internal (your team). It's a *decision*, not a slogan. | A one-page positioning statement |
...
| Brand | Branded search volume; "sounds like you" recognition; review sentiment ("easy to set up") | Mentions of *simple/easy* = brand promise believed |
