---
title: 'Tipping Points: Why Systems Break All at Once'
...
faq:
  - q: What is a tipping point in simple terms?
    a: A tipping point is the moment a system crosses a critical threshold and rapidly
      reorganizes into a completely different state. Before it, stabilizing forces hold
      things steady; after it, a runaway loop takes over and the change becomes hard to undo.
  - q: What is the difference between linear and nonlinear?
    a: In a linear relationship, doubling the cause doubles the effect, like turning a
      thermostat dial. In a nonlinear one, the effect is out of proportion to the cause,
      so a small push can produce a huge change or none at all.
  - q: Why do humans underestimate exponential growth?
    a: Our brains "linearize" curves, quietly assuming steady growth instead of
      acceleration. This exponential growth bias is well documented even in highly
      educated people, and simply knowing about it does not fix it.
  - q: What is hysteresis and why does it matter?
    a: Hysteresis means a system remembers where it came from, so the level that tips it
      forward is not the level that tips it back. It is why preventing a collapse, like a
      lake turning green, is often far cheaper than reversing one.
  - q: Can you predict exactly when a tipping point will happen?
...
1. **Hunt for the buildup, not the trigger.** When something breaks, ask "what accumulated to bring this to the edge?" before you blame the last event. Fix the structural cause or expect a repeat.
2. **Ask the reversibility question first.** Before acting, ask: is this change reversible, and at what cost? If hysteresis is in play, treat prevention as the cheap option and act early, even when nothing looks wrong yet.
