---
title: 'The True Cost of EMIs (and Why Cheap Loans Aren''t)'
metaTitle: 'EMI True Cost: Emergency Fund & Debt Guide'
description: >-
  Learn the true cost of EMIs, how much emergency fund you really need, and why
  early loan prepayment saves the most. A clear-headed guide to debt in India.
keywords:
  - true cost of EMI
  - emergency fund calculation
  - how much emergency fund do I need
  - EMI interest front-loaded
  - good debt vs bad debt
  - loan prepayment reduce tenure or EMI
  - credit card minimum payment trap
  - liquid funds vs FD tax
  - CIBIL score factors
...
faq:
  - q: How much should my emergency fund be?
    a: Keep 3 to 6 months of essential expenses, not your salary. Essentials are rent, EMIs, food, utilities, insurance and fees. Sole earners and freelancers should aim for 9 to 12 months.
  - q: Why is so much of my early EMI just interest?
    a: Loans amortise, meaning interest is charged on the outstanding balance, which is largest at the start. So early EMIs are mostly interest and barely touch the principal. That is why prepaying early saves the most.
  - q: Should I prepay my home loan or invest instead?
    a: Prepay whenever the loan rate beats the guaranteed post-tax return you could earn elsewhere. An 8.5% loan usually beats a taxed 7% FD. Against expected equity returns it is a judgement call, but always clear high-rate debt first.
  - q: When I prepay, should I reduce the EMI or the tenure?
    a: Choose to reduce the tenure. Keeping the EMI the same and finishing the loan sooner saves dramatically more interest than lowering the monthly payment.
  - q: Are liquid funds still better than fixed deposits for tax?
...
1. **Savings account plus a sweep-in FD.** A *sweep-in FD* automatically converts idle balance above a threshold into a fixed deposit (around 6.5 to 7%), then "breaks" it in small units as you spend. You get FD-like returns with savings-account convenience and instant access.
2. **Liquid mutual funds.** These invest only in instruments maturing within 91 days, so they barely move in value. Money reaches your account the next working day, and many offer **instant redemption up to ₹50,000 a day** (a SEBI cap). Yields run around 6.5 to 7% before tax.
3. **Overnight funds.** Even lower risk, for the slice you're slowest to touch.
...
1. **Payment history (about 35%, the biggest factor).** Never miss a due date.
2. **Credit utilisation.** The share of your card limit you use. Keep it **under 30%**.
3. **Length of your credit history.** Older is better.
4. **Credit mix.** A healthy blend of secured and unsecured loans.
5. **Recent hard enquiries.** Too many loan or card applications in a short window hurt.
...
1. **Calculate your real target.** Add up rent, EMIs, food, utilities, insurance and fees. Multiply by 3 to 6 (or up to 12 if you're a sole earner or freelancer).
2. **Park it properly.** One month's expenses in a savings or sweep-in FD, the rest in a liquid fund. Never in equity.
3. **Kill the costly debt first.** List every debt with its rate. Any card balance or loan above 20% gets cleared before you invest a rupee.
4. **Pay your full card statement, always.** Set an auto-debit for the full amount, never the minimum.
5. **Prepay smart.** If your loan rate beats a guaranteed post-tax alternative, prepay early and reduce the tenure, not the EMI.
6. **Protect your score.** Pay on time, keep card usage under 30% of the limit, check your one free annual credit report for errors, and don't close your oldest card.
