---
title: 'System Archetypes: The 8 Stories That Keep Repeating'
metaTitle: 'System Archetypes: 8 Patterns That Repeat'
description: >-
  System archetypes are the recurring loop patterns behind business failures,
  ecological collapse, and conflict. Learn to spot them and predict the ending.
keywords:
  - system archetypes
  - systems thinking
  - limits to growth
  ...
  - Donella Meadows system traps
  - reinforcing and balancing loops
faq:
  - q: What is a system archetype?
    a: >-
      A system archetype is a recurring causal loop structure that produces a
      recognizable pattern of behavior across many different settings. The names
      and details change, but the underlying "plot" stays the same.
  - q: How many system archetypes are there?
    a: >-
      Peter Senge named eight canonical archetypes in The Fifth Discipline, and
      Donella Meadows catalogued overlapping "system traps" in Thinking in
      Systems. Most lists settle on eight to ten common patterns.
  - q: What is the difference between Fixes that Fail and Shifting the Burden?
    a: >-
      In Fixes that Fail, the quick fix directly backfires later and worsens the
      original problem. In Shifting the Burden, the quick fix works but crowds
      out the slower fundamental solution, so real problem-solving capacity
      withers.
  - q: Is the Tragedy of the Commons inevitable?
    a: >-
      No. Elinor Ostrom won the 2009 Nobel Prize for showing that communities
      can self-govern shared resources sustainably, without privatization or
      top-down regulation, by adding feedback so each user feels the cost of
      their own use.
  - q: Why are system archetypes so hard to escape?
    a: >-
      Almost every archetype is a trap because of a delay between cause and
      effect. The short-term rational choice and the long-term rational choice
      point in opposite directions, so the trap feels reasonable from the inside.
  - q: Who created the system archetypes?
    a: >-
      They trace back to Jay Forrester's system dynamics work at MIT in the
      1950s and 60s. Peter Senge popularized eight of them in The Fifth
      Discipline (1990), and Donella Meadows expanded the catalogue in
