---
title: 'Why Good Strategies Die on Monday Morning'
metaTitle: 'Why Strategies Fail at Execution'
description: >-
  Most strategies fail in execution, not on the whiteboard. Learn how execution,
  growth discipline, and capital allocation decide which strategies actually win.
...
keywords:
  ...
  - emergent strategy
  - how CEOs allocate capital
  - BCG growth share matrix
  - strategic decision making
faq:
  - q: Why do most business strategies fail?
    a: >-
      Most strategies fail in execution, not in the idea. The gap between the
      plan and daily behaviour, growth that earns less than it costs, and poor
      capital decisions quietly destroy more value than wrong ideas do.
  - q: What is the difference between OKRs and the Balanced Scorecard?
    a: >-
      OKRs focus a team on a few ambitious priorities each quarter. The Balanced
      Scorecard tracks the whole organisation across four linked areas so
      leaders do not fixate on short-term finances. Use OKRs for focus and the
      scorecard for balance.
  - q: When does growth destroy value instead of creating it?
    a: >-
      Growth destroys value whenever the money invested earns less than it costs
      (its return on invested capital is below the cost of capital). A company
      can grow fast and get poorer at the same time.
  - q: What is capital allocation and why does it matter so much?
    a: >-
      Capital allocation is deciding where a company's cash goes: reinvesting,
      acquiring, paying debt, dividends, or buybacks. Over a career it is the
      single most consequential thing a CEO does, often creating most of the
      difference in value per share.
  - q: What is Rumelt's kernel of good strategy?
    a: >-
...
1. **Execution** turns a chosen strategy into what people actually do.
2. **Goal systems** keep the strategy alive all year, not just at the offsite.
3. **Growth** is where new revenue comes from, and where value quietly gets destroyed.
4. **Capital allocation** is the highest-leverage decision a leader ever makes.
...
1. **Run the kernel test.** State your diagnosis in one sentence. If you cannot, stop resourcing and fix that first.
2. **Audit your four levers.** Check that priorities, resources, structure, and incentives all point the same way. Look especially for an incentive that secretly contradicts the strategy.
3. **Pick a few priorities, not twenty.** Give each a single *named* owner. "The team" owns nothing.
4. **Set a review cadence.** A weekly check and a quarterly reset. An OKR or scorecard you do not review is decoration.
5. **Actually move money and people** to the priorities. A priority with no extra resource is a slogan.
6. **Write down your hurdle rate** (the cost of capital). Reject any use of cash that does not clear it, including "growth."
7. **Make every dollar compete.** Force reinvest, acquire, repay, dividend, and buyback to compete on risk-adjusted return. Default to the highest return, not the most exciting option.
8. **Before any bold move, ask "and then what?"** Play the second round before you commit.
