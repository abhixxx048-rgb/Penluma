---
title: 'Stocks, Flows, Feedback Loops: How Every System Works'
metaTitle: 'Stocks, Flows & Feedback Loops Explained'
description: >-
  Learn how stocks, flows, feedback loops, and delays drive every system around
  you, from your bank account to the climate, and why they fool almost everyone.
...
faq:
  - q: What is the difference between a stock and a flow?
    a: A stock is something that piles up and that you could measure at a single moment, like the water in a bathtub or money in your account. A flow is the rate at which that stock fills or drains, like the faucet pouring in or the drain letting out.
  - q: What are the two types of feedback loops?
    a: Balancing loops resist change and pull a stock toward a goal, like a thermostat holding a room at one temperature. Reinforcing loops amplify change so more leads to more, like compound interest snowballing.
  - q: Why does reducing emissions not lower CO2 right away?
    a: CO2 in the atmosphere is a stock, and emissions are only the inflow. The stock keeps rising as long as emissions stay above what oceans and plants absorb. Cutting emissions slows the rise, but the level only falls once the inflow drops below the outflow.
  - q: Why do systems oscillate or overshoot?
    a: Delays. When there is a lag between an action and its visible effect, you tend to overcorrect, then correct back, then overcorrect again, like fighting a slow shower dial. Delays inside feedback loops turn smooth steering into wild swinging.
...
| --- | --- | --- |
| Bank balance | Income | Spending |
| Body weight | Calories eaten | Calories burned |
| Company headcount | People hired | People who quit or are fired |
| Inventory | Goods received | Goods sold |
| Atmospheric CO2 | Emissions | Absorption by oceans and plants |
...
| Behavior over time | Settles toward a target | Explodes or collapses |
| Everyday picture | Thermostat, sweating, filling a glass | Compound interest, rumor, bank run |
| Nickname | Stabilizer | Snowball, vicious-or-virtuous cycle |
