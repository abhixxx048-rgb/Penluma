---
title: 'User Research for Beginners: The Mom Test and How to Watch'
metaTitle: 'User Research & The Mom Test: A Beginner Guide'
description: >-
  Learn user research the easy way: use The Mom Test to interview people without
  bias, watch users instead of asking, and turn real behavior into better products.
keywords:
  - user research
  - the mom test
  ...
  - 5 user usability rule
faq:
  - q: What is The Mom Test in simple terms?
    a: >-
      The Mom Test is a way to interview people so that even someone who loves you
      and wants to be nice cannot accidentally mislead you. You ask about their
      real past behavior and specific facts, never about your idea or their
      opinions of it.
  - q: How many users do you need for a usability test?
    a: >-
      For qualitative testing where you watch people do tasks, about five users
      reveal roughly 85% of the problems. Better still, run three small studies
      of five and fix issues between each round rather than one large study.
  - q: What is the difference between generative and evaluative research?
    a: >-
      Generative research happens early and discovers what problem to solve.
      Evaluative research happens later and tests how well a specific solution
      works. You use generative to find the right problem and evaluative to refine
      the answer.
  - q: Why shouldn't I just ask customers what they want?
    a: >-
      People are poor predictors of their own future behavior and often answer to
      be polite. What someone says they would do rarely matches what they actually
      do, so you learn far more by asking about specific past actions or watching
      them work.
  - q: Are surveys and analytics good for user research?
    a: >-
      They are great for confirming and sizing a pattern you already found, but
      poor for discovery. Numbers tell you how many and where people struggle;
...
| Biased question | Mom-Test question |
| --- | --- |
