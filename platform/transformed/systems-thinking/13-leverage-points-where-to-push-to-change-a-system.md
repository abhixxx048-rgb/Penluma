---
title: '12 Leverage Points: Where to Push to Change a System'
metaTitle: 'Leverage Points: Where to Change a System'
description: >-
  Donella Meadows' 12 leverage points show where a small push changes a whole
  system. Learn why the obvious levers are the weakest and where real power hides.
keywords:
  - leverage points
  ...
  - system dynamics
faq:
  - q: What are leverage points in systems thinking?
    a: >-
      A leverage point is a place in a system where a small, well-aimed change
      produces a large shift in how the whole system behaves. Donella Meadows
      ranked twelve of them from weakest (numbers and parameters) to strongest
  ...
  - q: Why are budgets and targets weak leverage points?
    a: >-
      Numbers like budgets, tax rates, and headcounts only adjust quantities
      inside a fixed structure. They rarely change behaviour unless they push
      the system past a tipping point, yet they attract most of our attention
      because they are easy to see and measure.
  - q: What is the difference between a balancing and reinforcing feedback loop?
    a: >-
      A balancing loop corrects deviation and brings stability, like a
      thermostat. A reinforcing loop amplifies change and drives growth or
      collapse, like compound interest. Slowing a runaway reinforcing loop is
      usually more effective than strengthening a balancing one.
  - q: Who came up with the 12 leverage points?
    a: >-
      Systems scientist Donella Meadows introduced them in her 1997 essay
      "Leverage Points: Places to Intervene in a System" and refined the list
...
The places people fight over hardest are usually the *weakest* places to push. The truly powerful ones are nearly invisible, so they get ignored.

That mismatch is expensive. It is why a company can pour years into stricter quotas and see no real change, while a single rewritten goal quietly reshapes everything. If you can learn to spot where a system is actually movable, you stop wasting effort on levers that barely budge it.

A **leverage point** is exactly that: a place where a small, well-aimed shift produces a large change in how the whole system behaves. Meadows ranked twelve of them, from weakest (number 12) to most powerful (number 1), in her 1997 essay and her 2008 book *Thinking in Systems*. This article walks you up that ladder.

## The system is a stack, top to bottom

Before the list, hold one idea: these levels are **stacked and causal**. Each one generates the level below it.

- The deepest level, the **paradigm**, sets the goals.
- **Goals** shape the **rules** and **information flows**.
- Those shape the **feedback loops**.
...
> **The faucet analogy:** Adjusting the faucet (a parameter) changes how fast the tub fills. But if there is no drain (structure), the tub overflows no matter how carefully you tune the faucet. Structure sets the *range* of possible outcomes; the parameter only works inside that range.
...
| --- | --- |
| Corrects deviation toward a goal | Amplifies change away from the start |
| Brings stability (thermostat) | Brings growth or collapse (compound interest) |
| Leverage = its strength | Leverage = its speed of compounding |
| Welfare catching people up | Wealth earning more wealth |
