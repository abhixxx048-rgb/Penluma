---
title: 'Discovery Call Guide: How to Run One Start to Finish'
metaTitle: 'How to Run a Great Discovery Call'
description: >-
  Learn how to run a great discovery call start to finish: a 30-minute map,
  the questions to ask, when to pitch, and how to lock a real next step.
keywords:
  - discovery call
...
faq:
  - q: What is a discovery call?
    a: A discovery call is your first real conversation with a potential customer. The goal is to understand their situation, their problems, and whether you can actually help, not to deliver a sales pitch.
  - q: How long should a discovery call be?
    a: Most discovery calls are booked for 30 minutes. Keep it to 30 unless both sides are clearly engaged and want to keep going. A simple time-box keeps you on track.
  - q: How much should I talk on a discovery call?
    a: Aim to listen about 70% of the time and talk about 30%. The person asking the questions is the one in control, and listening is where you learn what actually matters.
  - q: What questions should I ask on a discovery call?
    a: Use SPIN order, Situation, Problem, Implication, and Need-payoff, and lean on Mom Test questions about past behavior and real spending. Keep roughly 80% of your questions open-ended.
  - q: When should I talk about my product?
    a: Only after you understand the pain, usually around minute 22. Keep it short and tie it directly to the exact problem they described, never a feature dump of everything you do.
  - q: What should I do after a discovery call?
    a: Within 10 minutes, write detailed notes in their own words, log the call in your CRM, and send a recap email within 24 hours that confirms the agreed next step and date.
...
1. **Know the person and the company.** Glance at their website and the person's LinkedIn profile. Note what the company does, how big it is, and the person's role. This lets you skip dumb questions and tailor the good ones.
2. **Set ONE clear goal.** Not "close the deal." A realistic goal is: *understand their biggest problem and decide together whether a next step makes sense.* One goal keeps you calm.
3. **Write your agenda and questions.** A short list of 10 to 12 questions on a sheet you can glance at. Strong reps ask roughly 11 to 15 thoughtful questions per call, mostly open-ended ones.
...
1. **Prep for 15 minutes.** Research the person, set one goal, write 10 to 12 questions.
2. **Open in 3 minutes.** Rapport, agenda, permission. Confirm the time.
3. **Spend the middle on questions.** Run SPIN order, Situation, Problem, Implication, Need-payoff, and never skip Implication.
4. **Use Mom Test questions.** Ask about past behavior and real spending, not opinions.
5. **Pitch late and tiny.** One thing, tied to their exact words, around minute 22.
6. **Close on a date.** Summarize, confirm fit, offer two specific times, book the slot.
7. **Within 10 minutes,** write notes in their own words and log the call in your **CRM** (a Customer Relationship Management tool, even a spreadsheet works to start).
8. **Within 24 hours,** send a recap email: what we discussed, what we agreed, the next step and the date.
