...
This site is a growing library of deep research. Unlike most write-ups online,
these aren't cheat sheets. Each topic is built to take you from plain-language
intuition, to exact mechanics, to the failure modes that show up in a 3 a.m.
incident or a hard interview question.
...
> markdown file in `platform/posts/` with frontmatter (`title`, `topic`, `date`,
