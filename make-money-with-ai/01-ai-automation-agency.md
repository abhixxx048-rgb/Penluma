# 1. AI Automation Agency for Small Businesses

> **Time to first income:** 4-12 weeks | **Startup cost:** $0-100 | **Beginner earnings:** $200-1,500/month | **Experienced earnings:** $5,000-15,000/month | **Difficulty:** 3/5 | **AI-Future-Proof:** 3/5
...
A **workflow** is one connected chain of steps (form → calendar → text message). A **retainer** is a fixed monthly fee a client pays you to keep their workflows running and improve them over time.
...
1. **A one-time setup fee.** A small business owner pays you to build a workflow. Simple builds go for $500-2,000. Bigger projects, like an AI chatbot connected to a booking system, command $5,000-15,000.
2. **A monthly retainer.** The same client pays $1,000-5,000 per month (industry average around $3,200). In return, you monitor the workflows, fix breakages (software updates break automations constantly), and add improvements.
3. **Optional side income.** Hourly consulting on freelance platforms. n8n specialists on Upwork charge $40-100/hour, and there were about 800 open n8n jobs listed there in mid-2026.

One retained client can be worth $12,000-60,000 per year. Five retainer clients is a full-time income. That is the whole model.
...
- **Months 1-3:** $0-1,500 total. Many people earn nothing in this phase. That is normal, not failure. First money usually comes 4-12 weeks after outreach starts, often from one discounted build.
- **Months 4-6:** $500-3,000/month if you land 2-4 projects and your first retainers. Freelance data shows solo operators typically earn $200-1,500 per workflow build and $1,000-3,000 per monthly consulting retainer.
- **Year 1+:** $5,000-15,000/month is the commonly reported range for established solo agencies with 3-6 retainer clients. Sources disagree above that. Claims of $40,000/month solo operations exist, but they are the rare top end, not the median. Net margins for well-run shops are 20-35% after tool, AI, and oversight costs.
...
- Building impressive workflows nobody asked for, instead of solving one painful, boring task.

## Pro Tips

- Self-host n8n for clients. One $10-30/month server can run many client instances, keeping your costs near zero while cloud-based competitors pay per client.
