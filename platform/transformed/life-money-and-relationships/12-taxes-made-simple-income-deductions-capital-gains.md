---
title: 'Income Tax in India Made Simple: Slabs, Deductions, Gains'
metaTitle: 'Income Tax India: Slabs, Deductions & Gains'
description: >-
  A plain-English guide to income tax in India: how tax slabs really work,
  old vs new regime, the deductions that matter, and how capital gains are taxed.
...
faq:
  - q: Which tax regime should I choose, old or new?
    a: >-
      Compute your tax under both every year using the Income Tax Department's
      free calculator. The new regime usually wins if you claim few deductions;
      the old regime wins only when your deductions are large.
  - q: Does earning ₹1 more push my whole income into a higher tax slab?
    a: >-
      No. Slabs are progressive, so only the portion of income that falls inside
      a higher band is taxed at that higher rate. Your earlier income keeps its
      lower rates.
  - q: How much income is tax-free under the new regime?
    a: >-
      Income up to ₹12 lakh effectively pays zero tax thanks to the Section 87A
      rebate, and roughly ₹12.75 lakh for salaried people after the ₹75,000
      standard deduction. This rebate does not apply to capital gains.
  - q: How are capital gains on shares taxed in India?
    a: >-
      For listed shares and equity funds held over 12 months, the first
      ₹1.25 lakh of gains each year is tax-free and the rest is taxed at 12.5%.
      Sold within 12 months, the gain is taxed at 20%.
  - q: Do Section 80C and 80D deductions work in the new regime?
    a: >-
      No. Almost all deductions, including 80C and 80D, apply only under the old
      regime. That trade-off is exactly why the new regime offers lower rates.
...
1. **Run the regime comparison.** Use the Income Tax Department's official old-vs-new calculator to see which one fits you this year. It takes minutes.
2. **List the deductions you actually claim.** If the list is thin, the new regime is probably better. If you have a home loan, NPS, big insurance premiums, and house rent, check the old regime carefully.
3. **File on time.** The usual deadline is 31 July for individuals not requiring an audit, but verify the current date each year.
4. **Ring-fence tax on windfalls.** The moment a bonus, business profit, or capital gain lands, move the likely tax into a separate account before you spend a rupee of it. This single habit prevents most advance-tax penalties.
