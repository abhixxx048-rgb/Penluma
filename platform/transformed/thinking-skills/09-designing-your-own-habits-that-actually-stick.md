...
faq:
  ...
  - q: What is habit stacking?
    a: Habit stacking attaches a new habit to one you already do, using the formula "After I [current habit], I will [new habit]." Your existing routine acts as a built-in reminder, so you borrow its reliability.
...
Each step of the loop comes with a simple design rule. To build a good habit, apply all four. To break a bad one, flip each rule on its head.
...
Your brain acts on what it notices. If your running shoes are buried in the closet, you'll forget to run. If they're on the floor by your bed, you'll practically trip into them.

To build a habit, put the cue in plain sight:

- Your book on your pillow.
- Your vitamins next to the coffee maker.
- Your guitar on a stand in the living room, not in its case.

To break one, hide the cue:

- Phone in another room.
- Junk food out of the house entirely.
- Logged out of social media after every use.

Same principle, opposite directions. The person who wants to drink more water leaves a full glass on the counter each morning. The person who wants to stop scrolling at night charges their phone in the kitchen.
...
- Only listen to that one podcast while you walk.
...
Here's the most freeing idea in this whole article: **you are not lazy. You respond to friction.** When the easiest path leads to the good habit, you take it. When it leads to the bad one, you take that instead.

The fix is the **2-minute rule**: shrink any new habit until it takes two minutes or less to start.
...
- Phone in a drawer while you work.
- Social media apps deleted, login required each time.
- Snacks on the highest shelf, behind other things.

Every second of added effort makes the impulse a little weaker.
...
The four laws are the framework. These are the specific moves that put them into practice.

### Implementation intentions: turn vague plans into specific actions

Psychologist Peter Gollwitzer found that one of the most reliable ways to follow through is to decide *when* and *where* in advance. He called these plans **implementation intentions**, and across dozens of studies, people who used them were two to three times more likely to follow through.

The formula is simple:

> "I will [behavior] at [time] in [place]."

Not "I want to meditate more," but "I will meditate for five minutes at 7:00 AM in my bedroom before I check my phone." The specific plan makes the in-the-moment decision for you. Your brain already knows what happens next.

### Habit stacking: anchor new habits to old ones

Your existing habits are already burned into your brain. Borrow their strength. **Habit stacking** (popularized by James Clear, building on BJ Fogg's "Tiny Habits") attaches a new behavior to one you already do automatically.
...
3. Write three gratitudes *(new)*.
4. Read one page *(new)*.
5. Open the task list *(new)*.
6. Start work.

### Environment design: your space is your system

Willpower is finite. Your environment runs all day, every day, nudging every choice in the background. Design your space so the good option is the obvious default:

- Want to eat better? Fruit on the counter, chips in the garage.
- Want to read more? Book on the couch cushion, remote in a drawer.
...
Tracking turns an invisible behavior into a visible one. An X on a calendar or a checkmark in an app builds a chain, and the urge not to break the chain becomes its own motivation. In one study published in the *American Journal of Preventive Medicine*, people who tracked their food daily lost twice as much weight as those who didn't.
...
The tactics above work on their own. But two ideas make everything stick longer.
...
**"A relapse means I failed."** A relapse is a data point, not a verdict. It tells you exactly which part of your design was too weak.

## How to use this: your 1-page habit plan

Pick one habit and answer these as concretely as you can. Vague answers produce vague results.

1. **Name the habit.** What, specifically, do you want to build?
2. **Write the identity statement.** "I am the type of person who ____."
3. **Set the implementation intention.** "I will [behavior] at [time] in [place]."
4. **Choose a habit stack.** "After I [existing habit], I will [new habit]."
5. **Define the 2-minute version.** The smallest possible starting step.
