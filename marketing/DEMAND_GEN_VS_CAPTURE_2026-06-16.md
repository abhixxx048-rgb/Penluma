...
Research from Professor John Dawes at the **Ehrenberg-Bass Institute** (amplified by the **LinkedIn B2B Institute**) found that at any given moment only ~**5%** of B2B buyers are in-market; the other **95% are out-of-market** ([LinkedIn B2B Institute](https://business.linkedin.com/marketing-solutions/b2b-institute/b2b-research/trends/95-5-rule); [Ehrenberg-Bass](https://marketingscience.info/news-and-insights/the-955-rule-why-b2b-growth-starts-long-before-the-purchase)). The math: if a shop owner re-evaluates their online-storefront setup once every ~5 years, only ~20% are "in-market" in a given year and ~5% in a given quarter.
...
The market context is favorable: ~72% of printing companies had adopted some web-to-print by end of 2024, and ~50% of new small/mid printers cite web-to-print as their **top investment** ([Global Growth Insights](https://www.globalgrowthinsights.com/blog/web-to-print-software-companies-831); [PrintPlanr](https://www.printplanr.com/blog/why-your-print-shop-needs-web-to-print-software/)). That means in-market demand is real and growing - but the *non-technical independent shop* is exactly the under-served slice the incumbents (built for tech-comfortable mid-market) talk past. That gap is our generation wedge.

---

## 3. The Capture Stack (catch the 5% who are searching)

Capture is high-ROI and fast - BOFU (bottom-of-funnel) comparison and pricing pages can show results in 30–60 days because they target buyers already evaluating ([CXL](https://cxl.com/blog/bottom-of-funnel-content-b2b-seo/)). High-commercial-intent keywords convert ~10x better than informational ones. Build, in priority order:

1. **Comparison / "alternative" pages.** The single highest-leverage capture asset. Create honest pages: *"Print-Flow-360 vs OnPrintShop,"* *"OnPrintShop alternative for small print shops,"* *"Pressero alternative,"* *"DesignNBuy vs Print-Flow-360,"* *"Shopify for print shops - why it falls short on pricing."* People search these with wallet out.
2. **BOFU money keywords.** Target solution + intent modifiers: "web to print software," "online ordering system for print shops," "print shop ecommerce platform," "web to print with design tool." Each gets a dedicated, conversion-optimized page (demo CTA, screenshots, "go live this week").
3. **Pricing page that ranks.** Many search "[product] pricing" / "web to print software pricing." A clear, public-ish pricing page captures this and pre-qualifies.
4. **Paid search on the same terms** - small, tightly-scoped budget on the 10–20 highest-intent keywords above. Don't broaden; in-market volume is thin, so spend only where intent is unmistakable.
5. **Software directories & review sites.** Get listed and gather reviews on **G2, Capterra, GetApp, Software Advice, and Trustpilot** - these rank for our category terms and are where in-market buyers validate. Aim for 10+ reviews before chasing paid placement.
...
This is the harder, more durable engine. Demand creation for vertical SaaS runs on **founder credibility + community + education**, not search ads - because the audience isn't searching ([Insight Partners](https://www.insightpartners.com/ideas/top-3-questions-founders-saas-b2b-demand-gen/); [DemandZen](https://demandzen.com/rise-of-vertical-saas-b2b-saas-demand-generation/)). It spreads through **dark social** - word-of-mouth, group shares, DMs that never show up in analytics ([Refine Labs](https://www.refinelabs.com/article/hybrid-attribution-framework)).

**Go where print shop owners already gather:**

- **Facebook Groups** are the beating heart of this trade - e.g. *Screen Print Pros*, sign/print/promo-product owner groups where members troubleshoot business problems daily ([Printavo](https://www.printavo.com/blog/top-facebook-groups-for-screen-printers/)). Join, *help genuinely* (answer pricing/turnaround/online-ordering questions), don't pitch. This is where preference is built.
- **Trade associations & events** - PRINTING United, FESPA, PSDA, regional print associations. Vertical SaaS thrives at industry events where buyers congregate ([Wikipedia: FESPA](https://en.wikipedia.org/wiki/Fespa); [PSDA](https://en.wikipedia.org/wiki/Print_Services_%26_Distribution_Association)). Even a single regional trade show booth or sponsored local meetup beats broad ads.
...
Generic frameworks (Binet & Field's 60/40 brand/performance) are derived from *established* companies and are a trap for a seed-stage startup chasing product-market fit ([First Round Review](https://review.firstround.com/a-founders-framework-for-understanding-performance-vs-brand-marketing/)). The stage-appropriate guidance: pre-seed/seed should be heavily performance/capture-weighted (~70–90%) because capture gives instant proof the business works.
...
- **Watch branded search volume** - when generation works, people start Googling "Print-Flow-360" by name. Rising branded/direct traffic is the clearest proxy for upper-funnel effectiveness ([Dreamdata](https://dreamdata.io/blog/brand-vs-demand-marketing)).
...
- [Ehrenberg-Bass Institute - The 95:5 Rule: Why B2B Growth Starts Long Before the Purchase](https://marketingscience.info/news-and-insights/the-955-rule-why-b2b-growth-starts-long-before-the-purchase)
- [Refine Labs / Chris Walker](https://www.refinelabs.com/chris-walker) and the [Hybrid Attribution Framework](https://www.refinelabs.com/article/hybrid-attribution-framework)
- [CXL - Bottom-of-Funnel Content for B2B SEO](https://cxl.com/blog/bottom-of-funnel-content-b2b-seo/)
- [Insight Partners - Top 3 questions founders have about SaaS B2B demand gen](https://www.insightpartners.com/ideas/top-3-questions-founders-saas-b2b-demand-gen/)
- [DemandZen - Vertical SaaS & Community](https://demandzen.com/rise-of-vertical-saas-b2b-saas-demand-generation/)
- [First Round Review - Performance vs. Brand Marketing for Startups](https://review.firstround.com/a-founders-framework-for-understanding-performance-vs-brand-marketing/)
- [Dreamdata - Brand vs. Demand Marketing](https://dreamdata.io/blog/brand-vs-demand-marketing)
- [Global Growth Insights - Web to Print Software market & adoption](https://www.globalgrowthinsights.com/blog/web-to-print-software-companies-831)
- [Printavo - Top Facebook Groups for Screen Printers](https://www.printavo.com/blog/top-facebook-groups-for-screen-printers/)