---
title: 'Spaced Repetition: How to Beat the Forgetting Curve'
metaTitle: 'Spaced Repetition: Beat the Forgetting Curve'
description: >-
  Most of what you learn today is gone within a day. Spaced repetition uses the
  forgetting curve to make memories stick. Here is how it works and how to use it.
keywords:
  - spaced repetition
  - forgetting curve
...
faq:
  - q: What is the forgetting curve?
    a: >-
      It is the predictable pattern of how fast we lose new information. You
      forget roughly half of brand-new material within an hour and 70 to 80
      percent within a day, after which the loss slows down.
  - q: What is spaced repetition?
    a: >-
      It is a study method where you review material at expanding intervals,
      such as after 1 day, then 3 days, then a week, then a month. Each
      successful review pushes the next one further out.
  - q: Why is spaced repetition better than cramming?
    a: >-
      Cramming packs everything into one session, so the material feels fresh
      tomorrow but fades within days. Spacing the same study time across several
      days produces far more durable memory.
  - q: How long should I wait between reviews?
    a: >-
      Aim to review just before you would forget, so retrieval takes real
      effort but still succeeds. In practice, apps expand the gap each time you
      get an item right and shrink it back when you miss.
  - q: Does spaced repetition really work?
    a: >-
      Yes. It is one of the most robust findings in learning science, dating
      back to Hermann Ebbinghaus in the 1880s and confirmed by decades of
      research since. It works for vocabulary, facts, and most factual recall.
  - q: What is the difference between the spacing effect and spaced repetition?
    a: >-
