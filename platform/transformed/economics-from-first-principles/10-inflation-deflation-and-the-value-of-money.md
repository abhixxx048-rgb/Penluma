---
title: 'Inflation and Deflation: Why Your Money Keeps Losing Value'
metaTitle: 'Inflation vs Deflation: Why Money Loses Value'
description: >-
  Why does a coffee cost ten times what it did in 1980? This plain-English guide
  to inflation, deflation, and the value of money explains it without the jargon.
keywords:
  - what is inflation
...
faq:
  - q: What is the difference between inflation and deflation?
    a: >-
      Inflation is a sustained, broad rise in prices, so each unit of money buys
      less over time. Deflation is the opposite: prices fall across the board and
      money buys more. Steady deflation is usually more dangerous for an economy
      than mild inflation.
  - q: Is disinflation the same as deflation?
    a: >-
      No. Disinflation means prices are still rising, just more slowly (for
      example, inflation dropping from 9% to 3%). Deflation means prices are
      actually falling. People confuse these constantly.
  - q: Why do central banks aim for 2% inflation instead of 0%?
    a: >-
      A small positive cushion keeps the economy a safe distance from a
      deflationary spiral and gives policymakers room to cut interest rates in a
      downturn. Zero leaves no margin for error.
  - q: Who benefits from inflation and who loses?
    a: >-
      Fixed-rate borrowers, owners of real assets, and governments with debt tend
      to win because their debts shrink in real terms. Lenders, cash savers, and
      people on fixed incomes lose. Surprise inflation does the real damage.
  - q: What causes hyperinflation?
    a: >-
      Every recorded case traces back to a government printing money to fund
      spending it cannot cover with taxes or borrowing. It is a policy choice, not
      a market accident.
