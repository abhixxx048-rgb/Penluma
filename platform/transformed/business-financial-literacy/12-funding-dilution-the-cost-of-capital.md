---
title: 'Funding & Dilution: What Investor Money Really Costs You'
metaTitle: 'Funding, Dilution & Cost of Capital Explained'
description: >-
  Learn how dilution, valuation, and the cost of capital really work so you can
  walk into any investor meeting knowing exactly what their money costs you.
...
keywords:
  ...
  - startup valuation math
  - seed round dilution
faq:
  - q: What is the difference between pre-money and post-money valuation?
    a: >-
      Pre-money is what your company is worth before new investment arrives.
      Post-money is pre-money plus the new cash. The same headline number gives
      away different ownership depending on which one it is, so always ask which
      they mean.
  - q: How much equity do founders usually give up in a seed round?
    a: >-
      Seed rounds typically cost founders somewhere in the high teens to around
      20 percent. A common rule of thumb is to try to stay under 25 percent per
      round so you keep enough ownership to stay motivated.
  - q: Is dilution always bad for a founder?
    a: >-
      No. Dilution shrinks your percentage, but if the new money grows the
      company enough, your smaller slice can be worth far more than your old
      larger one. Owning 80 percent of a big company beats 100 percent of a tiny
      one.
  - q: What is the cost of capital?
    a: >-
      It is the price you pay to use someone else's money. For debt it is the
      interest rate. For equity it is all the future profit you give away
      forever, which usually makes equity the most expensive money you can take.
  - q: What is the Rule of 40?
    a: >-
      A quick health check that says your growth rate plus your profit margin
      should add up to at least 40. It lets a fast-growing but unprofitable
      company and a slow but profitable one both look healthy.
  - q: Should I bootstrap or raise money?
    a: >-
      Bootstrapping keeps full control and all the profit but grows slowly.
...
| **Profit** | All future profit is yours | You split profit by ownership % |
...
| If the business fails? | Investor loses their money | You still owe the money |
...
|---|---|
| Under 1x | Very efficient, you make more than a dollar per dollar spent |
| 1x – 1.5x | Healthy |
