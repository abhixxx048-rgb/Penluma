...
faq:
  - q: What is the difference between real and nominal?
    a: "Nominal numbers are measured in current dollars and include inflation. Real numbers strip inflation out so you see actual change. A 5% raise during 6% inflation is a real pay cut."
  - q: What actually causes inflation?
    a: "Sustained inflation happens when too much money chases too few goods. A one-time price jump in oil or eggs is not inflation, which is a broad, ongoing rise in the general price level."
  - q: Why do central banks aim for 2% inflation instead of zero?
    a: "A little inflation makes it easier to adjust wages and prices and keeps the economy a safe distance from dangerous deflation, where falling prices cause people to delay spending."
  - q: Does a higher GDP mean people are better off?
...
| Main tools | Interest rates, money supply | Spending, taxes |
...
| Distinction | Meaning | The trap it prevents |
|---|---|---|
| Nominal vs. real | Before vs. after stripping out inflation | Feeling richer from a 5% raise when inflation is 6% |
| Level vs. rate | How high something is vs. how fast it is changing | Thinking "inflation fell" means prices fell |
| Stock vs. flow | An amount at a moment vs. a flow over time | Confusing the national debt with the yearly deficit |
