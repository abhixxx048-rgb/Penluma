---
title: 'Supply and Demand: How Prices Really Get Set'
metaTitle: 'Supply and Demand: How Prices Get Set'
description: >-
  Nobody decides what your coffee costs, yet the price is never random. Here is
  how supply and demand quietly set prices for everything you buy.
keywords:
  - supply and demand
...
faq:
  - q: What is supply and demand in simple terms?
    a: >-
      Demand is how much buyers want at each price; supply is how much sellers
      offer at each price. The price settles where the two match, so the amount
      people want to buy equals the amount available.
  - q: How is the price of something actually determined?
    a: >-
      Price moves to the point where quantity demanded equals quantity supplied,
      called the equilibrium. If price is too high, unsold stock pushes it down;
      if too low, shortages push it up.
  - q: What is the difference between a movement along a curve and a shift?
    a: >-
      A movement happens only when the good's own price changes. A shift happens
      when something else changes, like income, tastes, or input costs, and it
      moves the whole curve left or right.
  - q: What does elastic and inelastic demand mean?
    a: >-
      Elastic demand reacts a lot to price changes, usually because substitutes
      exist. Inelastic demand barely reacts, like gasoline or life-saving
      medicine, because buyers have few alternatives.
  - q: Why do price ceilings like rent control cause shortages?
    a: >-
      A price ceiling set below equilibrium means buyers want more than sellers
      will supply. Since the price cannot legally rise to close that gap, the
      shortage becomes permanent, along with queues and quality decline.
...
- **R**elated goods (the price of *substitutes* like tea, or *complements* like milk)
- **I**ncome
- **B**uyers (how many there are)
- **E**xpectations about the future
...
1. It is a **signal**. A high price screams "we need more of this."
2. It is an **incentive**. That same high price pays producers to go make more.
3. It is a **rationing device**. It decides who gets a scarce good: those who value it most.
...
1. **Read every price as a signal.** When something jumps, ask whether supply fell or demand rose. The cause tells you whether the change will last.
2. **Separate the trigger from the reaction.** Before blaming "demand," confirm the good's own price did not move first for another reason.
3. **Run the substitutes test.** Few good alternatives means inelastic demand, so the seller has pricing power. Many alternatives means you, the buyer, hold the leverage.
4. **Use the total-revenue test on your own pricing.** If you sell something, ask whether a price rise would lose more customers than it gains in margin. Inelastic, raise it. Elastic, think twice.
5. **Spot price controls before you cheer them.** When a cap or floor is proposed, ask which side of equilibrium it lands on. Below equilibrium points to a shortage; above it points to a surplus.
6. **Hold the model and the data together.** Use supply and demand as your default prediction, then look for real-world evidence that nudges it.
