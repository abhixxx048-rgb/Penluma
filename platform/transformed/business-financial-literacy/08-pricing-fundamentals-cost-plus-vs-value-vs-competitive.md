---
title: "Pricing 101: Cost-Plus vs Value vs Competitive Pricing"
metaTitle: "Pricing Strategy: Cost-Plus vs Value vs Competitive"
description: "Learn the three pricing methods every founder needs: cost-plus, competitor, and value-based pricing. Stop underpricing and set your price on purpose."
keywords:
  - pricing strategy
  - cost-plus pricing
  - value-based pricing
...
faq:
  - q: "What is the difference between cost-plus and value-based pricing?"
    a: "Cost-plus starts from what it costs you to make something and adds a markup. Value-based pricing starts from what the result is worth to the customer. Value-based is usually far more profitable because it ignores your cost and focuses on the outcome."
  - q: "Is a 50% markup the same as a 50% margin?"
    a: "No. Markup is profit as a percentage of cost; margin is profit as a percentage of price. A 50% markup actually gives you about a 33% margin, which is why founders who confuse the two quietly underprice."
  - q: "How do I convert markup to margin?"
    a: "Use Margin = Markup ÷ (1 + Markup). For example, a 60% markup gives 0.60 ÷ 1.60 = 37.5% margin. To go the other way: Markup = Margin ÷ (1 − Margin)."
  - q: "What is a good gross margin for a software business?"
    a: "Most healthy SaaS businesses aim for a 70-80% gross margin, and many self-serve products clear 80% or more. Set your targets in margin, not markup, because margin shows the share of each sale you actually keep."
  - q: "Why do most founders underprice their products?"
    a: "Usually fear of rejection, anchoring on their own costs, and impostor doubt. A low price feels safe but signals 'cheap,' repels serious buyers, and starves the business of the margin it needs to survive."
...
| Term | Formula | The question it answers |
|------|---------|-------------------------|
...
| Subscription | A fixed fee every month or year | Ongoing software; predictable revenue |
