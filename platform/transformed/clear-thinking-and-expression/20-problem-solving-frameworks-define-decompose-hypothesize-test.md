---
title: 'How to Solve Any Problem: Define, Decompose, Test'
metaTitle: 'How to Solve Any Problem: A 6-Step Framework'
description: >-
  Learn a simple problem-solving framework that finds the real problem instead
  of the obvious one. Define, decompose, hypothesize, prioritize, test, iterate.
...
faq:
  - q: What are the steps in a problem-solving framework?
    a: >-
      Define the real problem as a measurable gap, decompose it into
      non-overlapping parts, write 3-5 testable hypotheses, prioritize by impact
      versus effort, test the top one cheaply, then iterate on what you learn.
  - q: What is the difference between problem-finding and problem-solving?
    a: >-
      Problem-finding is figuring out what the real problem actually is, which is
      slow but high-value. Problem-solving is building the fix once you know the
      problem, which is usually faster and easier.
  - q: What is the 5 Whys technique?
    a: >-
      The 5 Whys is a method from Toyota where you ask "why?" repeatedly, about
      five times, to dig past the symptom and reach the root cause of a problem.
  - q: What does MECE mean?
    a: >-
      MECE stands for "Mutually Exclusive, Collectively Exhaustive." It means the
      parts you break a problem into don't overlap and together they cover
      everything, so you have no double-counting and no gaps.
  - q: How do I know if I've defined a problem well?
    a: >-
...
Most people solve the wrong problem fast instead of the right problem slowly. They hear "sales are down," shout "we need to advertise more," and burn a budget fixing something that was never broken.

There's a better way, and it's not about being smarter. It's about running one repeatable process: **Define, Decompose, Hypothesize, Prioritize, Test, Iterate.** By the end of this article you'll have a six-step loop you can run on anything from "my revenue dropped" to "I can't focus," plus a worked example you can copy line for line.

## Why this matters

When you hear a problem, your brain rushes to fix it. That feels productive. It usually isn't, because you end up answering a question nobody asked.
...
5. Name the **smallest test** you could run this week.

Twenty minutes, one page. A few drills to sharpen the muscle:

- **De-solution drill.** Find three things you said this week that secretly contain a solution ("we need X"). Rewrite each as a pure problem statement.
