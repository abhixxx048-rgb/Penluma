---
title: "Burn Rate and Runway: The One Number That Keeps Your Startup Alive"
metaTitle: "Burn Rate & Runway: A Founder's Survival Guide"
description: "Learn how to calculate burn rate and runway, spot the death spiral early, and time your fundraise from strength. The cash math every founder needs."
keywords:
  - burn rate
  - startup runway
  ...
  - capital efficiency
  - startup failure cash
  - extend runway
  - SaaS burn rate
faq:
  - q: "What is the difference between gross burn and net burn?"
    a: "Gross burn is the total cash leaving your account each month across every expense. Net burn subtracts the revenue you collected, so it's the rate cash actually disappears. Net burn is the survival number."
  - q: "How do you calculate startup runway?"
    a: "Divide the cash in your bank by your net monthly burn. If you have 3.6 crore in the bank and burn 30 lakh a month, your runway is 12 months."
  - q: "What does 'default alive' mean?"
    a: "Default alive means that at your current growth and spending, you reach profitability before the cash runs out. Default dead means you run out first and need a successful raise just to survive."
  - q: "What is a good burn multiple?"
    a: "Around 2x is reasonable for an early-stage startup, meaning you burn 2 rupees to add 1 rupee of new annual recurring revenue. 5x is terrible, and below 1x is elite."
  - q: "When should a startup start fundraising?"
    a: "Start with roughly 9 to 12 months of runway left, because a round takes 3 to 6 months to close. Raising from near-empty destroys your leverage and signals desperation."
...
> Your monthly operating expenses are 40 lakh. That's your gross burn.
> You collected 10 lakh in revenue that month.
> **Net burn = 40L minus 10L = 30 lakh per month.**
...
> Cash in bank = 3.6 crore.
> Net burn = 30 lakh per month.
> **Runway = 3.6 Cr ÷ 0.30 Cr = 12 months.**
...
> Net burn drops to 40L minus 25L = **15 lakh per month**.
> On the same 3.6 crore, runway jumps from 12 months to 3.6 Cr ÷ 0.15 Cr = **24 months**.
...
> Last quarter, net burn was 3 crore and you added 1.5 crore of net new ARR.
> **Burn multiple = 3 Cr ÷ 1.5 Cr = 2.0x.** Reasonable.
...
> Cash 2.5 crore, gross burn 90 lakh per month, revenue 20 lakh, so net burn is 70 lakh.
> Runway = 2.5 Cr ÷ 0.70 Cr ≈ **3.6 months.**
