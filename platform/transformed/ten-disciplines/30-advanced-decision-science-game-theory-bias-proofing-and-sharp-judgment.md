---
title: 'Game Theory, Bias-Proofing, and How to Judge Your Own Judgment'
metaTitle: 'Game Theory & Bias-Proofing Your Decisions'
description: >-
  Learn how game theory, prospect theory, and a simple decision journal can
  bias-proof your judgment and help you make measurably better decisions for life.
keywords:
  - game theory for decisions
  - prisoner's dilemma
  - tit-for-tat strategy
  - bias-proofing decisions
  - prospect theory
  - loss aversion
  - decision journal
  - premortem technique
...
faq:
  - q: What is the difference between a good decision and a good outcome?
    a: A good decision is well-reasoned given what you knew at the time, under uncertainty. A good outcome is just how the dice landed. A smart 70% bet that loses was still a good decision, and a reckless gamble that wins was still a bad one.
  - q: What is a Nash equilibrium in simple terms?
    a: It is a stable situation where no single player can do better by changing only their own move. Crucially, stable does not mean good. Price wars and arms races are stable equilibria that leave everyone worse off.
  - q: Does knowing about a cognitive bias make you immune to it?
    a: No. Biases work like optical illusions. You can know two lines are the same length and they still look different. Awareness barely dents anchoring, loss aversion, or overconfidence, which is why you fix bias with process, not willpower.
  - q: What is a premortem?
    a: A premortem is imagining, before you commit, that your decision has already failed badly a year from now, then asking why. It surfaces doubts people would otherwise stay quiet about and beats optimism bias before you act.
  - q: What is a decision journal and why does it matter?
    a: It is a record of what you decided, your reasoning, and your probability estimate, written before you know the outcome. It is the single highest-leverage habit for better judgment because it kills hindsight bias and lets you score your real calibration.
  - q: Can anyone learn to make better predictions?
    a: Yes. Philip Tetlock's research showed trained ordinary people, called superforecasters, beat credentialed experts with classified data. They used better habits, not secret information, starting from base rates and updating in small steps.
...
2. **Knowing my brain is biased, how do I build a process that defends against it?** That is bias-proofing.
3. **How do I get measurably better at judgment over years, not just feel better?** That is calibration.
...
1. **We feel changes, not absolute wealth.** A €60,000 salary feels like a triumph to someone who earned €40,000 last year and a punishment to someone who earned €90,000. Same number, opposite feeling. Your **reference point** is everything.
2. **Losses hurt about twice as much as equal gains feel good.** This is **loss aversion**, and it quietly drives a huge share of bad financial decisions.
3. **We flip our risk attitude.** We play it safe to protect a gain (take the sure win) but turn into gamblers to avoid a loss (roll the dice rather than accept a sure hit).
...
1. **Anonymous estimates first.** Have everyone write their number or vote *privately, before discussion*, so the room cannot echo the first speaker.
2. **Assign a devil's advocate.** Make it someone's explicit job to argue the opposing case, so dissent is a duty rather than an act of courage.
3. **Disagree and commit.** Air the disagreement fully, then unite behind the decision so the team does not relitigate forever.
...
1. What you decided.
2. Why, including your key assumptions.
3. Your probability estimate ("65% chance of working").
4. What you expect to happen, and by when.
5. How you felt (tired, rushed, emotional all predict bad decisions).
...
1. **Frame.** Is this reversible? Match effort to stakes.
2. **Outside view.** Start from the base rate. What usually happens to choices like this?
3. **Think in bets.** Give a probability and a range, not a certainty.
4. **Who else?** Is anyone else deciding? Map the game. One-shot or repeated?
5. **Bias-proof.** Premortem, checklist, anonymous estimates, reframe gain versus loss.
6. **Journal.** Record the decision, reasoning, and odds *before* the outcome.
7. **Review and score.** Judge the decision, not the outcome. Update your calibration.
