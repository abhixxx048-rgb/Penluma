...
**Product wedge (shops):**
6. [ ] Ship **LocalBusiness schema** auto-injection on every storefront (highest leverage, lowest effort).
7. [ ] Build the **9-step "Local Presence" onboarding checklist** in admin.
8. [ ] Ship **review-request automation** off the order-complete event.
9. [ ] Spec the **GBP connection** integration; until live, add the guided "Connect your Google listing" prompt.
10. [ ] Build the **geo landing-page generator** (service × city) as a CMS block.
