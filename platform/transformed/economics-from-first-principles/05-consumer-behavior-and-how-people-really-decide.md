...
keywords:
  ...
  - willingness to pay
faq:
  - q: What is marginal utility in simple terms?
    a: Marginal utility is the extra satisfaction you get from one more unit of something. The first slice of pizza is bliss, the fifth is just okay. Each extra unit tends to give you less added value than the one before.
  - q: Why is water cheap but diamonds are expensive?
    a: Price follows marginal value, not total value. Water is so abundant that one more glass is nearly worthless, even though water as a whole is priceless. Diamonds are scarce, so each one is highly valued. This is the diamond-water paradox.
  - q: What is loss aversion?
    a: Loss aversion is the tendency to feel the pain of losing something more strongly than the pleasure of gaining the same thing. As a rough rule, a loss hurts about twice as much as an equal gain feels good.
  - q: What is the decoy effect?
    a: The decoy effect is when adding a deliberately bad option nudges you toward a more expensive choice by making it look like a bargain. It is a common pricing trick in subscriptions and menus.
  - q: Is behavioral economics saying people are irrational?
...
## The rare goods that get more popular as they get pricier
