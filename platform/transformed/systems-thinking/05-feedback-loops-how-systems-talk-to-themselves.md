...
metaTitle: 'Feedback Loops Explained Simply'
description: >-
  Feedback loops explained in plain language: how reinforcing and balancing
  loops drive growth, stability, oscillation, and collapse in real systems.
keywords:
  - feedback loops
  - reinforcing loop
  - balancing loop
  ...
  - delays in systems
faq:
  - q: What is a feedback loop in simple terms?
    a: A feedback loop is a closed circle of cause and effect where a change in
      something comes back around to change itself. The system feeds its own
      behavior instead of just reacting to the outside.
  - q: What is the difference between reinforcing and balancing loops?
    a: Reinforcing loops amplify change, so more leads to more (like compound
      interest). Balancing loops resist change and push toward a goal (like a
      thermostat holding a temperature).
  - q: Does positive feedback mean something good?
    a: No. In systems language, "positive" means feedback that reinforces the
      current direction, and "negative" means feedback that opposes it. A bank
      run is positive feedback and is clearly harmful.
  - q: Why do feedback loops cause oscillation?
    a: Oscillation happens when a balancing loop has a delay. You act on stale
      information, so each correction overshoots the goal, like adjusting a
      shower with slow-arriving water.
  - q: What is the Limits to Growth pattern?
    a: It is when a growth loop eventually runs into a constraint that caps it.
      The fix is to weaken the constraint, not to push harder on the growth
      engine.
...
| Behavior over time | Exponential growth or collapse | Settles toward a goal |
